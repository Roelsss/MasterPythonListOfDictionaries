...
print("Book Data:")
for book in books:
    print(f"ID: {book['id']}, Title: {book['title']}, Author: {book['author']}, Genre: {book['genre']}, Published Year: {book['published_year']}, ISBN: {book['isbn']}, Stock: {book['stock']}, Price: ${book['price']}")
